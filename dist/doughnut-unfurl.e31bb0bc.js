...
var arc = d3.arc().outerRadius(outerRadius).innerRadius(innerRadius).context(context);
var circle = d3.arc().startAngle(0).endAngle(2 * Math.PI).innerRadius(0).context(context);
...
//# sourceMappingURL=/doughnut-unfurl.e31bb0bc.js.map